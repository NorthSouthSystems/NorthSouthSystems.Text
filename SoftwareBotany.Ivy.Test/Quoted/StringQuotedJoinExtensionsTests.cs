...
namespace SoftwareBotany.Ivy
{
    ...
    public class StringQuotedJoinExtensionsTests
    {
        ...
        public void Simple()
        {
            ...
            sa = new string[] { "a", "b", "c" };
            result = sa.JoinQuoted(StringQuotedSignals.Csv);
            ...
            sa = new string[] { "aa", "bb", "cc" };
            result = sa.JoinQuoted(StringQuotedSignals.Csv, true);
            ...
            sa = new string[] { "a", "b", "c" };
            result = sa.JoinQuoted(new StringQuotedSignals("FOOBAR", null, null));
        ...
        {
            string[] strings = null;
            strings.JoinQuoted(StringQuotedSignals.Csv);
        }
        ...
        {
            string[] strings = new[] { "A" };
            strings.JoinQuoted(new StringQuotedSignals(",", null, null), true);
        }
