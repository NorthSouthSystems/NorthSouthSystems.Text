...
public class StringFixedExtensionsTests_SplitRepeating
{
    ...
    public void FillTrim()
    {
        ...
        rowsFields.Length.Should().Be(3);
        rowsFields[0].Should().Equal("1", "", "3");
        rowsFields[1].Should().Equal("4", "", "6");
        rowsFields[2].Should().Equal("7", "", "9");
